"""
Django settings for TecNotesPlus project.
...
SECRET_KEY = 'django-insecure-!u-pn5%$=e-fy(b0o_v=f%2%h^r=jo9tp3^y38)(h$d%(*e&#k'
...
ROOT_URLCONF = 'TecNotesPlus.urls'
...
TEMPLATES = [
    ...
    },
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'environment': 'TecNotesPlus.jinja2.environment',
